...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/indiesphere/IndieSphere.git", .branch("main"))
    ]
    + externalDependencies().map(\.package),
    targets: [
        .target(name: "App", dependencies: [
            .product(name: "IndieApp", package: "IndieSphere")
        ]
        + externalDependencies().flatMap(\.targets)),
        .target(name: "Tool", dependencies: [
            .product(name: "IndieCore", package: "IndieSphere")
        ]),
